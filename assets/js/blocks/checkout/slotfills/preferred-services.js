    ...
    return (
        <div className="wc-stc-dhl-preferred-days">
            <p className="wc-block-components-checkout-step__description">
                { _x( 'Choose a delivery day', 'dhl', 'shiptastic-integration-for-dhl' ) }
...
const DhlPreferredLocation = ( props ) => {
    ...
    return (
        <>
            { _x( 'Choose a weather-protected and non-visible place on your property, where we can deposit the parcel in your absence.', 'dhl', 'shiptastic-integration-for-dhl' ) }

            <ValidatedTextInput
                key="dhl-location"
                value={ location }
                id="dhl-location"
                label={ _x( "e.g. Garage, Terrace", 'dhl', 'shiptastic-integration-for-dhl' ) }
                name="dhl_location"
                required={ true }
                maxLength="80"
                onChange={ ( newValue ) => {
...
const DhlPreferredNeighbor = ( props ) => {
    ...
    return (
        <>
            { _x( 'Determine a person in your immediate neighborhood whom we can hand out your parcel in your absence. This person should live in the same building, directly opposite or next door.', 'dhl', 'shiptastic-integration-for-dhl' ) }

            <ValidatedTextInput
                key="dhl-preferred-neighbor-name"
                value={ neighborName }
                id="dhl-preferred-neighbor-name"
                label={ _x( "First name, last name of neighbor", 'dhl', 'shiptastic-integration-for-dhl' ) }
                required={ true }
                maxLength="25"
                onChange={ ( newValue ) => {
            ...
            <ValidatedTextInput
                ...
                required={ true }
                maxLength="55"
                label={ _x( "Street, number, postal code, city", 'dhl', 'shiptastic-integration-for-dhl' ) }
                onChange={ ( newValue ) => {
...
const DhlPreferredLocationSelect = ( props ) => {
    ...
    const options = [
        {
            value: '',
            label: _x( 'None', 'dhl location context', 'shiptastic-integration-for-dhl' ),
            content: '',
        },
        preferredLocationEnabled ?
        {
    ...
    return (
        <div className="wc-stc-dhl-preferred-location">
            <p className="wc-block-components-checkout-step__description">{ _x( 'Choose a preferred location', 'dhl', 'shiptastic-integration-for-dhl' ) }</p>
            <RadioControlAccordion
...
const DhlCdpOptions = (
    ...
    const options = [
        {
            value: 'cdp',
            label: _x( 'Shop', 'dhl', 'shiptastic-integration-for-dhl' ),
            content: (
                _x( 'Delivery to nearby parcel store/locker or to the front door.', 'dhl', 'shiptastic-integration-for-dhl' )
            ),
        ...
        {
            value: 'home',
            label: _x( 'Home Delivery', 'dhl', 'shiptastic-integration-for-dhl' ),
            content: (
                _x( 'Delivery usually to the front door.', 'dhl', 'shiptastic-integration-for-dhl' )
            ),
            secondaryLabel: costValue > 0 ? (
                <FormattedMonetaryAmount
                    currency={ currency }
    ...
    return (
        <div className="wc-stc-dhl-preferred-delivery">
            <p className="wc-block-components-checkout-step__description">{ _x( 'Choose a delivery type', 'dhl', 'shiptastic-integration-for-dhl' ) }</p>
    ...
    return (
        <div className="wc-stc-checkout-dhl">
            <h4 className="wc-stc-checkout-dhl-title">
                <span className="dhl-title">{ _x( 'DHL Preferred Delivery. Delivered just as you wish.', 'dhl', 'shiptastic-integration-for-dhl' ) }</span>
